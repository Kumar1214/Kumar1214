                ...
                <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                    ...
                    <div className="space-y-3">
                        {data.recentUsers?.map((visit, i) => (
                            <div key={i} className="flex justify-between items-center text-sm border-b border-gray-50 pb-2 last:border-0 hover:bg-gray-50 p-2 rounded transition-colors">
