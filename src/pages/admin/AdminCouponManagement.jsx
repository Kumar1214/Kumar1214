...
import { Plus, Edit, Trash2, Tag, Calendar, Percent, Users, Copy, CheckCircle, XCircle, Search } from 'lucide-react';
...
const AdminCouponManagement = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (editingCoupon) {
            ...
            setCoupons([...coupons, { ...formData, id: Date.now(), usedCount: 0, status: 'active' }]);
        }
        resetForm();
    };
