...
import { Search, Filter, Check, X, Eye, Plus, Store, MoreVertical, AlertCircle } from 'lucide-react';
                                ...
                                {filteredVendors.length > 0 ? (
                                    filteredVendors.map((vendor) => (
                                        <tr key={vendor.id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 text-right font-medium text-gray-900">₹{vendor.sales.toLocaleString()}</td>
