                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-green-600">₹{refunds.filter(r => r.status === 'approved').reduce((sum, r) => sum + r.amount, 0).toLocaleString()}</p>
                        </div>
                                ...
                                {filteredRefunds.length > 0 ? (
                                    filteredRefunds.map((refund) => (
                                        <tr key={refund.id} className="hover:bg-gray-50 transition-colors group relative">
                                            ...
                                            <td className="px-6 py-4 text-right font-bold text-gray-900">₹{refund.amount.toLocaleString()}</td>
                        ...
                        <div className="p-8">
                            <div className="grid grid-cols-2 gap-8 mb-8">
                                ...
                                <div className="text-right">
                                    ...
                                    <p className="text-3xl font-bold text-[#0c2d50]">₹{selectedRefund.amount.toLocaleString()}</p>
                                </div>
                            </div>
