...
import { Save, Monitor, Layout, FileCode, ToggleRight, DollarSign } from 'lucide-react';
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="flex items-center justify-between p-4 bg-orange-50 rounded-lg border border-orange-100">
            ...
            <div
              ...
              className={`w-14 h-7 rounded-full p-1 cursor-pointer transition-colors duration-200 ease-in-out ${settings.enableAds ? 'bg-orange-600' : 'bg-gray-300'}`}
            >
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <div
                  ...
                  className={`w-10 h-5 rounded-full p-0.5 cursor-pointer transition-colors duration-200 ease-in-out ${settings.popupAdEnabled ? 'bg-orange-600' : 'bg-gray-300'}`}
                >
