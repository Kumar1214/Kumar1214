...
// Helper component to render product grid content
const ProductGridContent = ({ loading, products, getImageUrl, isInWishlist, handleToggleWishlist, handleAddToCart, navigate, formatPrice, pageCount, pageParam, handlePageChange }) => {
    if (loading) {
        return (
        ...
        <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
                {products.map((product) => (
                    <ProductCard
                        key={product.id}
                        product={{ ...product, displayImage: getImageUrl(product.images?.[0]) }}
...
ProductGridContent.propTypes = {
    loading: PropTypes.bool.isRequired,
    products: PropTypes.array.isRequired,
    getImageUrl: PropTypes.func.isRequired,
    isInWishlist: PropTypes.func.isRequired,
    handleToggleWishlist: PropTypes.func.isRequired,
    handleAddToCart: PropTypes.func.isRequired,
    navigate: PropTypes.func.isRequired,
    formatPrice: PropTypes.func.isRequired,
    pageCount: PropTypes.number.isRequired,
    pageParam: PropTypes.number.isRequired,
                ...
                <div style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start', position: 'relative' }}>
                    ...
                    {showMobileFilters && (
                        <button
                            ...
                            style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', zIndex: 40, border: 'none', cursor: 'pointer', padding: 0 }}
                        />
                    )}
