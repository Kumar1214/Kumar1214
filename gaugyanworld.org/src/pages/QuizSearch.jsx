...
const QuizSearch = () => {
    ...
    const allQuizzes = [
        { id: 1, title: 'Daily Ayurveda Quiz', category: 'Ayurveda', duration: '10 min', questions: 20, difficulty: 'Easy', image: getImageUrl('https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?auto=format&fit=crop&q=80&w=200') },
        { id: 2, title: 'Yoga Asanas Identification', category: 'Yoga', duration: '15 min', questions: 30, difficulty: 'Medium', image: getImageUrl('https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop&q=80&w=200') },
        { id: 3, title: 'Sanskrit Vocabulary Test', category: 'Sanskrit', duration: '12 min', questions: 25, difficulty: 'Easy', image: getImageUrl('https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?auto=format&fit=crop&q=80&w=200') },
        { id: 4, title: 'Vedic Mathematics Quick Quiz', category: 'Vedic Studies', duration: '8 min', questions: 15, difficulty: 'Medium', image: getImageUrl('https://images.unsplash.com/photo-1509228468518-180dd4864904?auto=format&fit=crop&q=80&w=200') },
        { id: 5, title: 'Indian Culture Trivia', category: 'General Knowledge', duration: '10 min', questions: 20, difficulty: 'Easy', image: getImageUrl('https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?auto=format&fit=crop&q=80&w=200') },
    ];
                            ...
                            {filteredQuizzes.map(quiz => (
                                <div key={quiz.id} onClick={() => navigate(`/quizzes/${quiz.id}`)} className="card" style={{ padding: 'var(--spacing-md)', display: 'flex', gap: 'var(--spacing-md)', cursor: 'pointer', transition: 'transform 0.2s' }} onMouseEnter={(e) => e.currentTarget.style.transform = 'translateX(4px)'} onMouseLeave={(e) => e.currentTarget.style.transform = 'translateX(0)'}>
                                    <div style={{ width: '100px', height: '100px', borderRadius: 'var(--radius-md)', overflow: 'hidden', flexShrink: 0 }}>
                                        <img src={quiz.image} alt={quiz.title} style={{ width: '100%', height: '100%', objectFit: 'cover' }} onError={handleImgError} />
                                    </div>
                                    <div style={{ flex: 1 }}>
