...
const Coupons = () => {
    ...
    const getStatusButtonClass = (status) => {
        ...
        if (status === 'expired') return 'bg-gray-50 text-gray-500 border-gray-100 cursor-not-allowed';
                                ...
                                {filteredCoupons.map(coupon => (
                                    <tr key={coupon.id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            ...
                                            <div className="text-xs text-gray-500">Min spend: {formatPrice(coupon.minPurchase)}</div>
                                        </td>
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <button
                                                ...
                                                className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium capitalize border cursor-pointer ${getStatusButtonClass(coupon.status)}`}
                                            >
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in">
                    <div className="bg-white rounded-xl shadow-2xl p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="fixed">Fixed Amount ({formatPrice(0).replace(/\d|\./g, '').trim()})</option>
                                    </select>
                                </div>
                                <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Min Purchase ({formatPrice(0).replace(/\d|\./g, '').trim()})</label>
                                    <input
                                        type="number"
                                        min="0"
