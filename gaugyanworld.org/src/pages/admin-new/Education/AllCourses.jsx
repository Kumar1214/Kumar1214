...
import { Plus, Edit, Trash2, BookOpen, Filter, MoreVertical, X, ChevronLeft, Save, Video, FileText, HelpCircle, CheckCircle, Share2, TrendingUp, DollarSign, Users } from 'lucide-react';
          ...
          <>
            <AnalyticsGrid
              metrics={[
                ...
                { title: 'Total Revenue', value: analytics?.totalRevenue ? formatPrice(analytics.totalRevenue) : formatPrice(45600), icon: DollarSign, color: 'green', trend: 'up', trendValue: 22 },
                  ...
                  <div style={{ display: 'grid', gap: '16px' }}>
                    ...
                    <div style={{ marginBottom: '16px' }}>
                      ...
                      <FileUploader
                        ...
                        accept={getAcceptType(newClass.type)}
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {parseArrayField(formData.syllabus).length > 0 ? (
                  parseArrayField(formData.syllabus).map((cls, i) => (
                    <div key={cls.id || `cls-${i}`} style={{ padding: '16px', border: '1px solid #E5E7EB', borderRadius: '8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {parseArrayField(formData.includes).map((item, i) => (
                  <div key={`include-${i}`} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px', background: '#F9FAFB', borderRadius: '6px', border: '1px solid #E5E7EB' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {parseArrayField(formData.whatLearns).map((item, i) => (
                  <div key={`learn-${i}`} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px', background: '#F9FAFB', borderRadius: '6px', border: '1px solid #E5E7EB' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {parseArrayField(formData.chapters).map((item, i) => (
                  <div key={item.id || `chapter-${i}`} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px', background: 'white', borderRadius: '6px', border: '1px solid #E5E7EB' }}>
            ...
            <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '16px' }}>
                {parseArrayField(formData.relatedCourses).map((item, i) => (
                  <div key={item.id || `related-${i}`} style={{ padding: '12px', border: '1px solid #E5E7EB', borderRadius: '6px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#F9FAFB' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                {parseArrayField(formData.faqs).map((item, i) => (
                  <div key={item.id || `faq-${i}`} style={{ padding: '16px', border: '1px solid #E5E7EB', borderRadius: '8px' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                {parseArrayField(formData.reviews).map((item, i) => (
                  <div key={item.id || `review-${i}`} style={{ padding: '16px', border: '1px solid #E5E7EB', borderRadius: '8px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {parseArrayField(formData.studyMaterial).map((item, i) => (
                  <div key={item.id || `material-${i}`} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px', background: 'white', borderRadius: '6px', border: '1px solid #E5E7EB' }}>
