    ...
    {items && items.length > 0 ? (
      <div className="space-y-3">
        {items.slice(0, 5).map((item, index) => (
          <div key={item.id || index} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard icon={FiDollarSign} label="Total Revenue" value={formatPrice(totalRevenue)} bgColor="bg-emerald-50" iconColor="text-emerald-600" link="/admin/management/wallet" />
      </div>
