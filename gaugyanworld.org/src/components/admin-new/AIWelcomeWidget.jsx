                    ...
                    <div className="flex-1 md:max-w-xl">
                        <div className="space-y-3">
                            {data.summary.map((item, idx) => (
                                <div key={`${item.message}-${idx}`} className="bg-white/10 backdrop-blur-md border border-white/10 rounded-xl p-3 flex items-center justify-between hover:bg-white/20 transition-colors group">
