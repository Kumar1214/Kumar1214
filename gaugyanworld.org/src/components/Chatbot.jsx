                            ...
                            <div key={message.id} style={{
                                ...
                                <div style={{
                                    ...
                                    {message.text.split(/(\[.*?\]\(.*?\))/g).map((part, i) => {
                                        ...
                                        if (linkMatch) {
                                            return <span key={`link-${i}`} onClick={() => navigate(linkMatch[2])} style={{ textDecoration: 'underline', fontWeight: 600, cursor: 'pointer' }}>{linkMatch[1]}</span>;
                                        }
                        ...
                        <div style={{ padding: '12px 16px', backgroundColor: '#F3F4F6', borderTop: '1px solid #E5E7EB' }}>
                            ...
                            <div style={{ display: 'flex', gap: '8px', overflowX: 'auto', paddingBottom: '4px' }}>
                                {quickReplies.map((reply, idx) => (
                                    <button key={reply.action} onClick={() => handleQuickAction(reply.action)} style={{
                                        padding: '6px 12px',
