                                    ...
                                    {user ? (
                                        <>
                                            ...
                                            <button
                                                ...
                                                style={{ padding: '8px 12px', borderRadius: 'var(--radius-sm)', color: '#EF4444', textDecoration: 'none', display: 'block', cursor: 'pointer', background: 'none', border: 'none', textAlign: 'left', width: '100%' }}
                                            >
                                                Logout
                                            </button>
                                        </>
                ...
                {isOpen && (
                    <div style={{
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)' }}>
                            ...
                            {user && (
                                <button onClick={() => { logout(); window.location.href = '/login'; }} style={{ color: '#EF4444', cursor: 'pointer', paddingLeft: '28px', background: 'none', border: 'none', textAlign: 'left', width: '100%' }}>
                                    Logout
                                </button>
                            )}
